...
| Dzień / Wieczór / Noc | `DayBand` / `EveningBand` / `NightBand` | Trzy pasma; zakresy domyślne: dzień 6:00–22:00, wieczór 22:00–24:00, noc 0:00–6:00. Edycja dwiema granicami (Day starts / Evening starts), noc zawsze zaczyna się o północy — doba zawsze pokryta (ADR-0025). Klasyfikacja po czasie startu. | "rano/południe" (nie ma takiego pasma) |
...
| Ulubione drużyny | `FavoriteTeam` | Lista drużyn oznaczonych przez użytkownika. Ikona systemowa: **serduszko ♥** (gwiazdka ☆ należy wyłącznie do watchlisty wydarzeń — ADR-0034). Wyróżnia ich mecze (serduszko na wierszach/kartach + chip "N my teams" w nagłówkach dnia), daje szybki dostęp do terminarzów i zasila filtr "tylko moje drużyny". | "obserwowane drużyny" (myli się z watchlistą wydarzeń) |
