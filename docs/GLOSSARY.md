...
| Okno danych | `DataWindow` | Zakres czasowy snapshotu: 7 dni wstecz + 14 dni w przód od generacji. Przeszłość karmi sekcję "past" watchlisty; horyzont pokrywa tydzień + zapas na stronicowanie. | "cache TTL", "retencja" |
